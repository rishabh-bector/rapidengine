...
PFNGLEVALMESH2PROC glad_glEvalPrimitive2;
PFNGLEVALMESH1PROC glad_glEvalPrimitive1;
...
static void load_GL_VERSION_1_0(GLADloadproc load) {
	...
	glad_glEvalPrimitive1 = (PFNGLEVALMESH1PROC)load("glEvalPrimitive1");
	glad_glEvalPoint1 = (PFNGLEVALPOINT1PROC)load("glEvalPoint1");
	glad_glEvalPrimitive2 = (PFNGLEVALMESH2PROC)load("glEvalPrimitive2");
